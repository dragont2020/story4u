...
<head>
    ...
    <link href="<?php echo HOME ?>/files/systems/bootstrap/css/bootstrap.css" type="text/css" rel="stylesheet"/>
    <!-- Global styles END -->
    <!-- Theme styles START -->
...
<div class="main">
    <div class="container">
    <div class="vipLoad"><p><?php ZenView::get_title() ?></p>
...
<script type="text/javascript" src="/files/systems/js/jquery/jquery-3.1.0.min.js"></script>
