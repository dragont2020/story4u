...
ZenView::section(ZenView::get_title(true), function() {
    ...
    ZenView::block('Thông tin cập nhật', function() {
        ...
        <button type="submit" name="submit-update" class="btn ' . (ZenView::$D['new_version']->downloadable ? 'btn-success' : 'btn-warning') . '">' . (ZenView::$D['new_version']->downloadable ? '<span class="fa fa-level-up"></span> Nâng cấp' : '<span class="fa fa-shopping-cart"></span> ' . number_format(ZenView::$D['new_version']->amount) . ZenView::$D['new_version']->currency) . '</button>
