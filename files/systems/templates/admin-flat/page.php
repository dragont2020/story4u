...
<head>
    ...
    <link href="http://fonts.googleapis.com/css?family=Roboto+Condensed|Coiny|Kanit|Lalezar|Lobster|Patrick+Hand|Open+Sans:400,300,600,700&subset=all" rel="stylesheet" type="text/css"/>
    ...
    <link href="<?php echo REAL_HOME ?>/files/systems/w3/w3.css" rel="stylesheet" type="text/css"/>
    <!-- END THEME STYLES -->
...
<div class="page-content-wrapper">
    <div class="page-content" style="background-color: darkgray;">
        <div class="col-md-12" style="min-height: 780px;">
...
<div class="page-footer">
    ...
    <div class="col-lg-5" style="height: 31px;">
        <img id="online" src='http://c-stat.eu/c.php?u=69704'/>
    </div>
    <div class="col-lg-2">
...
<script src="<?php echo REAL_HOME ?>/files/systems/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
...
<script>
    jQuery(document).ready(function () {
        ...
        $('.page-title').html(span($('.page-title').html()));
        neon();
    });
</script>
